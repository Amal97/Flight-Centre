...
TestResult testFlightAddFlightAttendants() {
	cout << "Starting setFlightAttendant Tests" << endl;
	cout << "Commencing tests for short flights" << endl;
...
//Testing for rearranged order of above test languages
TestResult testFlightAddFlightAttendants2() {
	...
	FlightAttendant *jacky = new FlightAttendant("Jacky", 34);
	jacky->addLanguage(Country::ENGLISH);
...
TestResult testFlightAddFlightAttendants5() {
	...
	vector<FlightAttendant*> flightAttendants;
	FlightAttendant *bob = new FlightAttendant("Bob", 23);
	bob->addLanguage(Country::ARABIC);
...
TestResult testFlightAddFlightAttendants7() {
	cout << "End of tests for correct combinations for short flights" << endl;
	cout << "Commencing tests for filtering unrequired languages" << endl;
	Country *source = new Country("Cairo", Country::ARABIC);
	Country *destination = new Country("Madrid", Country::SPANISH);
	...
	FlightAttendant *jacky = new FlightAttendant("Jacky", 34);
	jacky->addLanguage(Country::SPANISH);
	jacky->addLanguage(Country::HINDI);
	...
	FlightAttendant *sara = new FlightAttendant("Sara", 19);
	sara->addLanguage(Country::ENGLISH);
	sara->addLanguage(Country::HINDI);
	flightAttendants.push_back(sara);
	ASSERT(flight.setFlightAttendants(flightAttendants));
...
TestResult testFlightAddFlightAttendants8() {
	Country *source = new Country("Cairo", Country::ARABIC);
	Country *destination = new Country("Madrid", Country::SPANISH);
...
TestResult testFlightAddFlightAttendants9() {
	Country *source = new Country("Cairo", Country::ARABIC);
	Country *destination = new Country("Madrid", Country::SPANISH);
...
TestResult testFlightAddFlightAttendants10() {
	Country *source = new Country("Cairo", Country::ARABIC);
	Country *destination = new Country("Madrid", Country::SPANISH);
	...
	FlightAttendant *james = new FlightAttendant("James", 1);
	james->addLanguage(Country::SPANISH);

	flightAttendants.push_back(james);
	ASSERT(!flight.setFlightAttendants(flightAttendants));

	FlightAttendant *jimmy= new FlightAttendant("Jimmy", 34);
	jimmy->addLanguage(Country::ENGLISH);

	flightAttendants.push_back(jimmy);
	ASSERT(!flight.setFlightAttendants(flightAttendants));

	FlightAttendant *joe = new FlightAttendant("Joe", 19);
	joe->addLanguage(Country::ARABIC);
	flightAttendants.push_back(joe);
	ASSERT(flight.setFlightAttendants(flightAttendants));


	return TR_PASS;
}
TestResult testFlightAddFlightAttendants11() {
	Country *source = new Country("Cairo", Country::ARABIC);
	Country *destination = new Country("Madrid", Country::SPANISH);
	...
	FlightAttendant *james = new FlightAttendant("James", 1);
	james->addLanguage(Country::CHINESE);
	...
	FlightAttendant *joe = new FlightAttendant("Joe", 19);
	joe->addLanguage(Country::ENGLISH);
	flightAttendants.push_back(joe);
	ASSERT(!flight.setFlightAttendants(flightAttendants));
...
vector<TestResult (*)()> generateTests() {
	...
	tests.push_back(&testFlightAddFlightAttendants8);
	tests.push_back(&testFlightAddFlightAttendants9);
#endif /*ENABLE_T3_TESTS*/
